...
public class MainMallGoodsDecoration extends RecyclerView.ItemDecoration {
    ...
    public MainMallGoodsDecoration(int space) {
        this.space = space;
    }

    public MainMallGoodsDecoration(int space, int color) {
        this.space = space;
        this.color = color;
    ...
    public MainMallGoodsDecoration(int space, int color, int type) {
        this.space = space;
        this.color = color;
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mPaint.setColor(color);
    ...
    public MainMallGoodsDecoration(int space, Drawable mDivider) {
        this.space = space;
