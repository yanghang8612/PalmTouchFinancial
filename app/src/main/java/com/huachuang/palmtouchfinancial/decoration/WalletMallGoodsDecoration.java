package com.huachuang.palmtouchfinancial.decoration;
...
public class WalletMallGoodsDecoration extends RecyclerView.ItemDecoration {
    ...
    public WalletMallGoodsDecoration(int space) {
        this.space = space;
    }

    public WalletMallGoodsDecoration(int space, int color) {
        this.space = space;
        this.color = color;
    ...
    public WalletMallGoodsDecoration(int space, int color,int type) {
        this.space = space;
        this.color = color;
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mPaint.setColor(color);
    ...
    public WalletMallGoodsDecoration(int space, Drawable mDivider) {
        this.space = space;
